...
<html lang="es">
 ...
 <body>
    ...
    <hr>
    <button type="button" class="btn btn-sucess" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo"><img src="img/nuevo.jpg" class="rounded float-left" width="100" height="100" alt="Agregar"></button>
        		...
        		<tr>
            		...
            		<td>
            			<button class="btn btn-sucess" 
            				...
            				data-codigo_empleado="<?php echo $dato->codigo; ?>" 
            				onclick="agregaformEliminar('<?php echo $datos ?>')"><img src="img/eliminar.png" width="50" height="50">
      ...
      <div class="modal-body">
        <form id="eliminar" action="eliminar.php" method="post">
          <div class="form-group">
            <label for="nombres" class="col-form-label">¿Está seguro que desea eliminar?</label>
            <input type="hidden" class="form-control" id="codigoempleado" name="codigoempleado">
          </div>
          <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal"  onclick="location.reload()">Cerrar</button>
        <button type="submit" class="btn btn-danger" id="enviar">Confirmar</button>
      </div>
        </form>
        <div class="mt-3" id="respuestaEliminar"></div></div>
      </div>
    </div>
  </div>
